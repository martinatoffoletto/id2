...
from main import (
    obtener_habitaciones, modificar_habitacion, eliminar_habitacion, obtener_hoteles, agregar_habitacion,obtener_amenities_tipo_habitacion, obtener_tipos_habitacion
)

def manage_rooms():
    tab1,tab2,tab3=st.tabs(["Modificar o Eliminar Habitación","Agregar Habitación", "Amenities de una habitacion"])
    with tab1:
        ...
        if habitacion_seleccionada:
            ...
            st.write(habitacion_seleccionada)
    ...
    with tab3:
        habitaciones = obtener_tipos_habitacion()
        habitacion_seleccionada = st.selectbox("Seleccione una habitación", habitaciones)
        st.dataframe(obtener_amenities_tipo_habitacion(habitacion_seleccionada))
